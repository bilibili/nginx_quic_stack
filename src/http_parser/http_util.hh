...
#ifndef BVC_HTTP_HTTP_UTIL_H_
#define BVC_HTTP_HTTP_UTIL_H_
#include <stddef.h>
#include <stdint.h>
#include <set>
#include <string>
...
class HttpUtil {
 public:
  ...
  // RFC 7231).
  static bool IsMethodSafe(gurl_base::StringPiece method);
  // Returns true if the request method is idempotent (per section 4.2.2 of
  // RFC 7231).
  static bool IsMethodIdempotent(gurl_base::StringPiece method);
  ...
  // validity.
  static bool IsSafeHeader(gurl_base::StringPiece name);
  ...
  static bool IsNonCoalescingHeader(gurl_base::StringPiece name);
  ...
  static bool IsParmName(gurl_base::StringPiece str);
  // RFC 2616 Sec 2.2:
  ...
  static std::string Unquote(gurl_base::StringPiece str);
  ...
  static bool StrictUnquote(gurl_base::StringPiece str,
                            std::string* out) WARN_UNUSED_RESULT;
  // The reverse of Unquote() -- escapes and surrounds with "
  static std::string Quote(gurl_base::StringPiece str);
  ...
  //                         HttpResponseHeaders.
  static std::string AssembleRawHeaders(gurl_base::StringPiece buf);
  ...
  static bool StringToInt64(const gurl_base::StringPiece &in, int64_t *out); 
  ...
  class HeadersIterator {
   public:
    ...
    gurl_base::StringPiece name_piece() const {
      return gurl_base::StringPiece(name_begin_, name_end_);
    }
    ...
    gurl_base::StringPiece values_piece() const {
      return gurl_base::StringPiece(values_begin_, values_end_);
    }
   private:
    gurl_base::StringTokenizer lines_;
  ...
  class ValuesIterator {
   public:
    ...
    gurl_base::StringPiece value_piece() const {
      return gurl_base::StringPiece(value_begin_, value_end_);
    }
   private:
    gurl_base::StringTokenizer values_;
   ...
   public:
    ...
    gurl_base::StringPiece value_piece() const {
      return value_is_quoted_ ? unquoted_value_
                              : gurl_base::StringPiece(value_begin_, value_end_);
    }
